//
//  CategoryListViewController_extension.swift
//  Piano
//
...
extension CategoryListViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        var reusableView = collectionView.dequeueReusableSupplementaryView(ofKind: kind, withReuseIdentifier: dataSource[indexPath.section][indexPath.item].sectionIdentifier ?? CategoryTitleReusableView.identifier, for: indexPath) as! CollectionDataAcceptable & UICollectionReusableView
